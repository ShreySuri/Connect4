...
if co_ord == 11:
    ...
    add_to_list(4, 5, 6, 7, 33, 34, 47, 52, 57, 60, 68, 68, 68)
elif co_ord == 52:
    add_to_list(5, 6, 7, 36, 37, 48, 58, 61, 68, 68, 68, 68, 68)
elif co_ord == 62:
    add_to_list(6, 7, 39, 40, 59, 62, 68, 68, 68, 68, 68, 68, 68)
elif co_ord == 72:
    add_to_list(7, 42, 43, 63, 68, 68, 68, 68, 68, 68, 68, 68, 68)
